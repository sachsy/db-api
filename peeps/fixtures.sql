...
INSERT INTO people (id, email, name, address, public_id, hashpass, lopass, newpass, company, city, state, postalcode, country, phone, notes, email_count, listype, categorize_as, created_at) VALUES (6, 'augustus@gloop.de', 'Augustus Gloop', 'Master Gloop', NULL, '$2a$08$JmphXF9YeW7Fi2IQVUnZtenBU2Ftacz454V1B1Ort4/VZhFgpMzWO', 'AKyv', '8LLRaMwm', NULL, 'Munich', NULL, 'E01515', 'DE', NULL, NULL, 0, 'some', NULL, '2010-11-01');
INSERT INTO people (id, email, name, address, public_id, hashpass, lopass, newpass, company, city, state, postalcode, country, phone, notes, email_count, listype, categorize_as, created_at) VALUES (7, 'gong@li.cn', '巩俐', '巩俐', NULL, '$2a$08$x/C0JU7r7Obp2Ar/1G0kz.t.mrW/r0Nan0sDggw3wjjBdr6jvcpge', 'FBvY', 'xPAJKaRm', 'Gong Li', 'Shanghai', NULL, '987654', 'CN', NULL, NULL, 2, NULL, 'translator', '2010-12-12');
INSERT INTO people (id, email, name, address, public_id, hashpass, lopass, newpass, company, city, state, postalcode, country, phone, notes, email_count, listype, categorize_as, created_at) VALUES (8, 'yoko@ono.com', 'Yoko Ono', 'Ono-San', NULL, '$2a$08$3yMZNGqUsUH3bQaCE7Rmbeay6FHW/Us2axycwUMDsvGKSDGlVfZPS', 'uUyS', 'ysIFMj3L', 'yoko@lennon.com', 'Tokyo', NULL, '22534', 'JP', NULL, NULL, 0, NULL, 'translator', '2010-12-12');
INSERT INTO people (id, email, name, address, public_id, hashpass, lopass, newpass, company, city, state, postalcode, country, phone, notes, email_count, listype, categorize_as, created_at) VALUES (1, 'derek@sivers.org', 'Derek Sivers', 'Derek', 'abcd', '$2a$08$0yI7Vpn3UNEf5q.muDgLL.y5GJRM5ak2awUOnd9z9ZCBFoCz0/Rfy', 'yTAy', 'Dyh15IHs', '50POP LLC', 'Singapore', NULL, '018980', 'SG', '+65 9763 3568', 'This is me.', 0, 'all', 'derek', '1994-11-01');
INSERT INTO people (id, email, name, address, public_id, hashpass, lopass, newpass, company, city, state, postalcode, country, phone, notes, email_count, listype, categorize_as, created_at) VALUES (2, 'willy@wonka.com', 'Willy Wonka', 'Mr. Wonka', 'efgh', '$2a$08$3UjNlK6PbXMXC7Rh.EVIFeRcvmij/b8bSfNZ.MwwmD8QtQ0sy2zje', 'R5Gf', 'NvaGAkHK', 'Wonka Chocolate Inc', 'Hershey', 'PA', '12354', 'US', '+1 215 555 1034', NULL, 2, 'some', NULL, '2000-01-01');
...
INSERT INTO people (id, email, name, address, public_id, hashpass, lopass, newpass, company, city, state, postalcode, country, phone, notes, email_count, listype, categorize_as, created_at) VALUES (4, 'charlie@bucket.org', 'Charlie Buckets', 'Charlie', 'mnop', '$2a$08$Nf7VymjLuGGUhMl9lGTPAO0GrNq0bE5yTVMyimlFR2f7SmTMNxN46', 'AgA2', 'fdkeWoID', NULL, 'Hershey', 'PA', '12354', 'US', NULL, NULL, 0, 'all', NULL, '2010-09-01');
INSERT INTO people (id, email, name, address, public_id, hashpass, lopass, newpass, company, city, state, postalcode, country, phone, notes, email_count, listype, categorize_as, created_at) VALUES (5, 'oompa@loompa.mm', 'Oompa Loompa', 'Oompa Loompa', 'qrst', '$2a$08$vr40BeQAbNFkKaes4WPPw.lCQKPsyzAsNPRVQ2bPgVVatyvtwSKSO', 'LYtp', 'a5JDIleE', NULL, 'Hershey', 'PA', '12354', 'US', NULL, NULL, 0, NULL, NULL, '2010-10-01');
...
INSERT INTO formletters (id, title, explanation, subject, body, created_at) VALUES (1, 'one', 'use for one', '{address} your email', 'Your email is {email}. Here is your URL: https://sivers.org/u/{id}/{newpass}', '2014-12-22');
